     ...
     if (!selectedParticipantId) {
      ...
      if (action === 'edit') {
        ...
        setAlertDialog({
          ...
          message: 'Rename wiring is ready; text-entry UI will be added in a follow-up step.',
          buttons: [{ label: 'OK' }],
        });
        return;
      }
      ...
      setAlertDialog({
        ...
        message: 'Delete wiring is ready; list mutation UI will be added in a follow-up step.',
        buttons: [{ label: 'OK' }],
      });
   }
