...
- [ ] **LEDR-01**: Organizer can create a new trip ledger with title and settlement context on device without internet.
- [ ] **LEDR-02**: Organizer can add participants as passive names inside the ledger.
